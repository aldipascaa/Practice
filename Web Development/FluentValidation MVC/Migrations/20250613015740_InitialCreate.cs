    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "StudentID", "Branch", "Email", "EnrollmentDate", "Gender", "Name", "PhoneNumber", "Section" },
                values: new object[,]
                {
                    { 1, "Computer Science", "john.smith@university.edu", new DateTime(2023, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Male", "John Smith", null, "A" },
                    { 2, "Engineering", "sarah.johnson@university.edu", new DateTime(2023, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Female", "Sarah Johnson", null, "B" },
                    { 3, "Business Administration", "mike.davis@university.edu", new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Male", "Mike Davis", null, "A" }
                });
